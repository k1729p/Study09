...
<P><img src="images/MermaidFlowchart.png" height="230" width="455"/><br>
...
<p>
This is the <a href="https://docs.spring.io/spring-framework/docs/current/reference/html/web.html">Spring Web MVC</a> and 
...
<P><IMG src="images/MermaidClassDiagram.png" height="460" width="520"/><BR>
<img src="images/blackArrowUp.png">
...
into an '<i>org.springframework.hateoas.RepresentationModel</i>'.<br>
...
<img src="images/orangeSquare.png"> 2. On this '<i>home page</i>' select '<i>Load sample dataset</i>' 
<img src="images/orangeHR-500.png"></p>
...
<P>
<IMG src="images/ScreenshotHomePage.png" height="490" width="555"/><BR>
<img src="images/blackArrowUp.png">
...
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/DepartmentController.java#L88">
kp.company.controller.DepartmentController::findAllDepartments</a>.
</P>
<P><IMG src="images/GetAllDepartments.png" height="920" width="540"/><BR>
<img src="images/blackArrowUp.png">
...
The controller GET method: 
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/DepartmentController.java#L68">
kp.company.controller.DepartmentController::findDepartmentById</a>.
</P>
<P><IMG src="images/GetDepartmentById.png" height="415" width="460"/><BR>
<img src="images/blackArrowUp.png">
...
The controller GET method: 
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/EmployeeController.java#L96">
kp.company.controller.EmployeeController::findAllEmployees</a>.
</P>
<P><IMG src="images/GetEmployees.png" height="1250" width="540"/><BR>
<img src="images/blackArrowUp.png">
...
The controller GET method: 
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/EmployeeController.java#L76">
kp.company.controller.EmployeeController::findEmployeeById</a>.
</P>
<P><IMG src="images/GetEmployeesById.png" height="295" width="460"/><BR>
<img src="images/blackArrowUp.png">
...
<P><IMG src="images/ConsumingRestUsingAngularJS.png" height="115" width="650"/><BR>
<img src="images/blackArrowUp.png">
...
<P><IMG src="images/ConsumingRestUsingJQuery.png" height="110" width="570"/><BR>
<img src="images/blackArrowUp.png">
...
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/DepartmentController.java#L49">
kp.company.controller.DepartmentController::createDepartment</a>.<br>
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/EmployeeController.java#L51">
...
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/DepartmentController.java#L103">
kp.company.controller.DepartmentController::updateDepartment</a>.<br>
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/EmployeeController.java#L110">
...
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/DepartmentController.java#L126">
kp.company.controller.DepartmentController::deleteDepartment</a>.<br>
<a href="https://github.com/k1729p/Study09/blob/main/src/main/java/kp/company/controller/EmployeeController.java#L142">
