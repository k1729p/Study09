...
public class DepartmentController {
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Department>> createDepartment(@RequestBody Department department) {

        if (Optional.ofNullable(department).isEmpty()) {
            logger.error("createDepartment(): bad request - empty request body");
            return ResponseEntity.badRequest().build();
        }
        final ResponseEntity<@NonNull EntityModel<@NonNull Department>> responseEntity = saveDepartment(department);
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Department>> findDepartmentById(@PathVariable("id") Long id) {

        if (Optional.ofNullable(id).isEmpty()) {
            logger.error("findDepartmentById(): bad request - empty id parameter");
            return ResponseEntity.badRequest().build();
        }
        final ResponseEntity<@NonNull EntityModel<@NonNull Department>> responseEntity = SampleDataset.findDepartmentById(id)
    ...
    public ResponseEntity<@NonNull CollectionModel<@NonNull EntityModel<@NonNull Department>>> findAllDepartments() {

        final ResponseEntity<@NonNull CollectionModel<@NonNull EntityModel<@NonNull Department>>> responseEntity = SampleDataset.findAllDepartments()
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Department>> updateDepartment(@RequestBody Department department,
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Department>> deleteDepartment(@PathVariable("id") Long id) {
        ...
        final ResponseEntity<@NonNull EntityModel<@NonNull Department>> responseEntity = ResponseEntity.noContent().build();
     ...
     * @return the {@link ResponseEntity} with the {@link EntityModel} for the {@link Department}
     */
    private ResponseEntity<@NonNull EntityModel<@NonNull Department>> saveDepartment(Department department) {
        try {
            SampleDataset.saveDepartment(department);
            final EntityModel<@NonNull Department> entityModel = assembler.toModel(department);
