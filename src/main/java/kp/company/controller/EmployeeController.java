...
public class EmployeeController {
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Employee>> createEmployee(@RequestBody Employee employee) {
        ...
        final ResponseEntity<@NonNull EntityModel<@NonNull Employee>> responseEntity = saveEmployee(employee);
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Employee>> findEmployeeById(@PathVariable("id") Long id) {

        if (Optional.ofNullable(id).isEmpty()) {
            logger.error("findEmployeeById(): bad request - empty id parameter");
            return ResponseEntity.badRequest().build();
        }
        final ResponseEntity<@NonNull EntityModel<@NonNull Employee>> responseEntity = SampleDataset.findEmployeeById(id)
    ...
    public ResponseEntity<@NonNull CollectionModel<@NonNull EntityModel<@NonNull Employee>>> findAllEmployees() {

        final ResponseEntity<@NonNull CollectionModel<@NonNull EntityModel<@NonNull Employee>>> responseEntity = SampleDataset.findAllEmployees()
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Employee>> updateEmployee(
    ...
    public ResponseEntity<@NonNull EntityModel<@NonNull Employee>> deleteEmployee(@PathVariable("id") Long id) {
        ...
        final ResponseEntity<@NonNull EntityModel<@NonNull Employee>> responseEntity = ResponseEntity.noContent().build();
     ...
     * @return the {@link ResponseEntity} with the {@link EntityModel} for the {@link Employee}
     */
    private ResponseEntity<@NonNull EntityModel<@NonNull Employee>> saveEmployee(Employee employee) {
        try {
            SampleDataset.saveEmployee(employee);
            final EntityModel<@NonNull Employee> entityModel = assembler.toModel(employee);
