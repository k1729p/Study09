...
class EmployeeClientSideTests {
	...
	void shouldFindEmployeeById() {
		...
		assertEquals(EXPECTED_EMPLOYEE_ID, employee.id());
		assertEquals(EXPECTED_EMPLOYEE_F_NAME, employee.firstName());
		assertEquals(EXPECTED_EMPLOYEE_L_NAME, employee.lastName());
