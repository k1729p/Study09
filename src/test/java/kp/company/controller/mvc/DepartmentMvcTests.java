...
class DepartmentMvcTests extends MVCTestsBase {
     ...
     */
    @Test
    @DisplayName("🟥 should get not found error when searching with absent department")
     ...
     */
    @Test
    @DisplayName("🟥 should get bad request error when searching with bad id")
     ...
     */
    @Test
    @DisplayName("🟥 should get not found error when updating with absent department")
